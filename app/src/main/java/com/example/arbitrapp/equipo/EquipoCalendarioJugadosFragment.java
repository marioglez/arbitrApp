...
public class EquipoCalendarioJugadosFragment extends Fragment {
    ...
    public EquipoCalendarioJugadosFragment(ArrayList<Partido> partidos){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_equipo_calendario_jugados, container, false);

        relativeLayout = view.findViewById(R.id.equipo_calendario_jugados_Layout);
